...
# MAGIC %sql
# MAGIC create or replace temp view products_bronze as (select * from rk_databricks.bronze.products)

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE TABLE if NOT EXISTS rk_databricks.silver.products (
...
# MAGIC )
# MAGIC MERGE INTO rk_databricks.silver.products sp
# MAGIC USING (
...
# MAGIC %sql
# MAGIC select * from rk_databricks.silver.products
